...
$resultat = mysqli_query ($connexion, $AddPublication );
           if ($resultat === TRUE){
            echo"Votre publication à bien été envoyée";
            ...
            echo "Il n'y a pas d'image ou il y a juste eu une erreur avec celle ci. Merci de mdifier cette image";
        }
}}else{
    echo "<h1>Vous êtes banni,vous ne pouvez donc plus poster de publications.</h1>";
}
