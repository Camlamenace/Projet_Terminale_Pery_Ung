...
--Maintenant on va pour les examples mettres des utilisateur et des commentaires
...
-- On va créer mainetant des utilisateur normaux (Leur mot de passe est "utilisateur")
...
INSERT INTO user VALUES('Ung' , 'Jacques' ,'Miroo' ,'$2y$10$h3/i5daAyLVTtBiKlN6HQ.rSmC5QLlSvA/YP/iy48oYC/mIDqxLgG',NULL ,'profil/Miroo.jpg',0 ,0, 0,0);
CREATE TABLE util3Abonnement(user VARCHAR(30));
CREATE TABLE util3Like(NumeroId INT);
INSERT INTO user VALUES('Jean' , 'Bon' ,'utilisateur' ,'$2y$10$h3/i5daAyLVTtBiKlN6HQ.rSmC5QLlSvA/YP/iy48oYC/mIDqxLgG',NULL ,'image/profilvide.png',0 ,0, 0,0);
...
INSERT INTO publications ( NomUtil , lienImage , DescriptionImage , dateActu, aime ,prive ) VALUES('Miroo' , 'publication/publi3.png' ,'Enfin finis Mario 64 : )' ,'2023-05-06 09:02:50',0,0);
INSERT INTO publications ( NomUtil , lienImage , DescriptionImage , dateActu, aime ,prive ) VALUES('Miroo' , 'publication/publi4.png' ,'C\'est beau' ,'2023-05-06 09:02:50',0,0);
INSERT INTO publications ( NomUtil , lienImage , DescriptionImage , dateActu, aime ,prive ) VALUES('utilisateur' , 'publication/publi5.png' ,'Omg Hogwarts legacy est sorti!!!' ,'2023-05-06 09:02:50',0,1);
...
INSERT INTO commentaire (NomUtil, TexteCom, idPublication) VALUES('utilisateur','Gors naze',1);
